...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("What menu item number would you like to order? ") 
    ...
    while True:
        ...
        if keep_ordering.lower() == "y":       
            ...
            # their order
            print("Your order is complete. Thank you for your ordering with Chi-town!")
...
for item in order_list:
    # Print out the item name, price, and quantity
